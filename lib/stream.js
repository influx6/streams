require('em.js')('streams',function(e){
  ...
  streams.Streamable = as.Class.create({
    ...
    bind: function(streamable){
      ...
      var self = this,fn = util.proxy(streamable.emit,streamable);
  ...
  streams.EventStreams = as.Class.create({
      static:{
          combineUnOrderBy: function(fn,fns){
            return function(){
              var scope =  {},
      ...
      instance:{
        ...
        stream: function(id,len,stream){
          ...
          var load = ((!!stream && util.instanceOf(stream,streams.Streamable)) ? 
            stream : ((len && util.isNumber(len)) ? 
            streams.CappedStreamable(len) : streams.Streamable.make()));
  ...
  streams.combineUnOrderByStreams = function(fn,fns){
    return streams.EventStreams.combineUnOrderBy(fn,fns);
  };
